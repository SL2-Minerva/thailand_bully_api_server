...
class BullyExport implements FromCollection, WithHeadings
{
    /**
    ...
    */
    ...
    public function collection()
    {
        ...
        if ($this->report_number === '6.2.002' ||
            $this->report_number === '6.2.003' ||
            $this->report_number === '6.2.004' ||
            $this->report_number === '6.2.006' ||
            $this->report_number === '6.2.007' ||
            $this->report_number === '6.2.008' ||
            $this->report_number === '6.2.012' ||
            $this->report_number === '6.2.013' ||
            $this->report_number === '6.2.014' ||
            $this->report_number === '6.2.016' ||
            $this->report_number === '6.2.017' ||
            $this->report_number === '6.2.018'
        ) {
        ...
        if ($this->report_number === '6.2.005' ||
            $this->report_number === '6.2.015'
        ) {
            foreach ($items as $item) {
