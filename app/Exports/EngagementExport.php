...
class EngagementExport implements FromCollection, WithHeadings
{
    /**
    ...
    */
    ...
    public function collection()
    {
        ...
        if ($this->report_number === '4.2.002' ||
            $this->report_number === '4.2.003' ||
            $this->report_number === '4.2.004' ||
            $this->report_number === '4.2.006' ||
            $this->report_number === '4.2.007' ||
            $this->report_number === '4.2.008' ||
            $this->report_number === '4.2.012' ||
            $this->report_number === '4.2.013' ||
            $this->report_number === '4.2.014' ||
            $this->report_number === '4.2.016' ||
            $this->report_number === '4.2.017'
        ) {
        ...
        if ($this->report_number === '4.2.005' ||
            $this->report_number === '4.2.015'
        ) {
            foreach ($items as $item) {
