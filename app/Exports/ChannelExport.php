...
class ChannelExport implements FromCollection, WithHeadings
{
    /**
    ...
    */
    ...
    public function collection()
    {
        ...
        if ($this->report_number === '3.2.002' ||
            $this->report_number === '3.2.003' ||
            $this->report_number === '3.2.004' ||
            $this->report_number === '3.2.006' ||
            $this->report_number === '3.2.007' ||
            $this->report_number === '3.2.008' ||
            $this->report_number === '3.2.009'
        ) {
