...
class SentimentDashboardController extends Controller
{
    ...
    public function sentimentBy(Request $request)
    {
        ...
        // $raw = $raw->whereIn('classifications.name', ['Positive', 'Negative', 'Neutral']);

        return parent::handleRespond([
            "SentimentByDay" => $this->SentimentByDay($raw, true),
            "SentimentByTime" => $this->SentimentByTime($raw, true),
            "SentimentByDevice" => $this->SentimentByDevice($raw, true),
            "SentimentByAccount" => $this->SentimentByAccount($raw, true),
            "SentimentByChannel" => $this->SentimentByChannel($raw, true),
            "SentimentBullyLevel" => $this->SentimentBullyLevel($request, true),
            "SentimentBullyType" => $this->SentimentBullyType($raw, true),
            "SentimentScore" => $this->SentimentScore($raw, true),
            "sentimentComparison" => $this->SentimentComparison($raw, true),
        ]);
    }
    ...
    private function sentiment($raw, $only_data = false)
    {
        $labels = [
            "Positive",
            "Neutral",
        ...
        $raw->whereIn('classifications.name', ['Positive', 'Negative', 'Neutral']);
        $items = $raw->get();
    ...
    public function SentimentByDay($raw, $only_data = false)
    {
    ...
    public function SentimentByTime($raw, $only_data = false)
    {
    ...
    public function SentimentByDevice($raw, $only_data = false)
    {
    ...
    public function SentimentByAccount($raw, $only_data = false)
    {
        ...
        $follower_raw = $this->raw_message_classification_one($this->campaign_id, $this->start_date, $this->end_date);
        $followers = $follower_raw->where('reference_message_id', '!=', '')->get();
    ...
    public function SentimentByChannel($raw, $only_data = false)
    {
    ...
    public function SentimentBullyLevel($raw, $only_data = false)
    {
        ...
        $raw = $raw->whereIn('classifications.name', ['Positive', 'Negative', 'Neutral', 'Level 0', 'Level 1', 'Level 2', 'Level 3']);
        $items = $raw->get();
...
//        dd($anylsys);
    ...
    {
        $raw_current = $this->raw_message_classification_one($this->campaign_id, $this->start_date, $this->end_date);
        $raw_previous = $this->raw_message_classification_one($this->campaign_id, $this->start_date_previous, $this->end_date_previous);
    ...
    public function PeriodOverPeriod($raw_current, $raw_previous, $only_data = false)
    {
        ...
        $data['totalSentiment'] = [
            ...
            "comparison" => floatval(parent::point_two_digits($totalEngagement_current - $totalEngagement_previous !== 0 ? $this->overPeriodComparison($totalEngagement_current, $totalEngagement_previous) : 0)),
        ...
        $data['neutral'] = [
            ...
            "comparison" => floatval(parent::point_two_digits($total_comment_current - $total_comment_previous !== 0 ? (($total_comment_current - $total_comment_previous) / $total_comment_previous * 100) : 0)),
        ...
        $data['positive'] = [
            ...
            "comparison" => floatval(parent::point_two_digits($total_share_current - $total_share_previous !== 0 ? (($total_share_current - $total_share_previous) / $total_share_previous * 100) : 0)),
        ...
        $data['negative'] = [
            ...
            "comparison" => floatval(parent::point_two_digits($this->overPeriodComparison($total_reactions_current, $total_reactions_previous))),
    ...
    {
        $raw_current = $this->raw_message_classification_one($this->campaign_id, $start_date, $end_data);
...
//
    ...
    public function SentimentScore($raw, $only_data = false)
    {
...
//
    ...
    {
        $raw = $this->raw_message_classification($this->campaign_id, $start_date, $end_date)
            ->whereIn('classifications.name', ['Positive', 'Negative', 'Neutral']);
    ...
    public function SentimentComparison($raw, $only_data = false)
    {
    ...
    public function SummaryScoreAccount(Request $request, $only_data = false)
    {
        ...
        $raw = $this->raw_message_classification_one($this->campaign_id, $this->start_date, $this->end_date);
        $raw = $raw->where('message_type', 'Post');
...
//        ];
    ...
    private function raw_message_classification_one($campaign_id, $start_date, $end_date)
    {
        $keyword = Keyword::where('campaign_id', $campaign_id);
